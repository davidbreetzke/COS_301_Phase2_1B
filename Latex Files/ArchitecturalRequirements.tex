...
%---------------------------------------------------------
	...
	\subsection{Reliability and Availability}
		...
		\subsubsection{Details:}
			\textbf{}The system should not crash, freeze or hang. The system must be available 99% of the time. If the system encounters an error, administrators should be notified.
